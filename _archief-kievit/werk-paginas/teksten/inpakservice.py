"""Eigen tekst voor /inpakservice/ op de BESTAANDE blokken. Ontwerp blijft ongemoeid.
...
Bronmateriaal met de al geschreven tekst: _werk/paginas/teksten-bewaard/inpakservice.html
Herbouwen: python3 _werk/build_paginas.py
"""

BESCHRIJVING = 'Inpakservice in Venlo en omgeving: wij leveren de verhuisdozen, pakken uw inboedel in en halen de lege dozen na de verhuizing weer bij u op.'
...
VERVANG = [
    ...
    ('Verhuizen zonder verhuisstress',
     'Laat het inpakken aan ons over'),
    ...
    ('Met De Kievit weet u vooraf waar u aan toe bent: wij komen langs, spreken alles met u door en leggen het vast in een offerte, zodat er op de dag zelf niets meer uitgezocht hoeft te worden. Als Erkende Verhuizer werken wij volgens de branchevoorwaarden van de Organisatie voor Erkende Verhuizers, met een Garantiecertificaat en een verzekering van uw inboedel. U houdt van de opname tot de laatste doos hetzelfde aanspreekpunt.',
     'Inpakken is het deel van een verhuizing dat het langst duurt en het vaakst misgaat. Wij pakken uw hele huis in, of alleen de kwetsbare delen, en zetten het op het nieuwe adres weer uit de doos. Dozen, papier, tape en garderobedozen brengen wij mee; wat overblijft gaat weer met ons terug. En tussen zelf pakken en laten pakken zit een verschil in dekking dat de moeite is om te kennen voordat u kiest.'),
    # <h3>, 19 tekens
    ('Opgeleid eigen team',
     'Ons eigen inpakteam'),
    # <p>, 279 tekens
    ('Ons verhuisteam is in dienst en opgeleid. Van het team dat bij u inpakt, ophaalt en aflevert heeft minstens de helft een erkend verhuisdiploma; dat is de norm van Erkende Verhuizers waar wij aan gebonden zijn. Wij zijn daarnaast erkend leerbedrijf. Geen wisselende invalkrachten.',
     'Het inpakken doen dezelfde mensen die ook ophalen en afleveren: in dienst en opgeleid. Van dat team heeft minstens de helft een erkend verhuisdiploma, de norm van Erkende Verhuizers waar wij aan gebonden zijn. Wij zijn daarnaast erkend leerbedrijf. Geen wisselende invalkrachten.'),
    # <h3>, 18 tekens
    ('Alles volgens plan',
     'U kiest wat u afgeeft'),
    # <p>, 192 tekens
    ('Voor de verhuizing komen wij bij u langs en maken wij samen een plan, zodat u op de dag zelf nergens aan hoeft te denken. U weet vooraf hoe laat wij er zijn en wanneer alles op uw adres staat.',
     'Bij de opname loopt de verhuisadviseur met u langs wat u zelf doet en wat wij doen. Alleen het breekbare kan ook. Wat u kiest komt zo in de offerte, want alleen wat is overeengekomen valt er later ook onder.'),
    # <h3>, 25 tekens
    ('Verzekerd en gegarandeerd',
     'Wat wij pakken, is gedekt'),
    # <p>, 225 tekens
    ('Uw inboedel is tijdens een verhuizing binnen Nederland verzekerd tot ten minste 100.000 euro op nieuwwaarde, en het Garantiecertificaat van Erkende Verhuizers beschermt uw aanbetaling en garandeert dat de verhuizing doorgaat.',
     'Wat wij inpakken, valt binnen de opdracht en binnen de dekking. Schade aan zaken die niet door de verhuizer zijn ingepakt valt daar juist buiten, tenzij die schade aan onze handelingen ligt. Laat u alleen het breekbare doen, dan dekt u de categorie waar het meestal misgaat.'),
    # <p>, 210 tekens
    ...
    ('Vakmensen met een verhuisdiploma en verstand van zaken',
     'Vakmensen die weten hoe een doos gevuld hoort te zijn'),
    ...
    ('De Kievit stelt hoge eisen aan haar medewerkers en materieel. Uw verhuizing wordt uitgevoerd door goed opgeleide vakmensen: gediplomeerde inboedelverhuizers die uw inboedel inpakken, uw meubels demonteren en monteren en alles veilig op de plaats van bestemming brengen. Sinds 1 juni 2024 maakt De Kievit deel uit van De Bresser Verhuizingen; het hele team uit Venlo ging daarbij mee, dus u ziet dezelfde vertrouwde gezichten aan de deur.',
     'De Kievit stelt hoge eisen aan haar medewerkers en materieel. Glaswerk, servies, spiegels en lijsten gaan met papier ertussen de doos in, borden op hun kant en nooit plat, boeken in kleine dozen omdat zwaar in klein hoort. Wat aan hangers hangt gaat rechtstreeks in een garderobedoos en op het nieuwe adres weer terug de kast in. Op elke doos komt de kamer waar hij heen moet; zeg bij de opname hoe u de ruimtes noemt, dan staat dat er ook op.'),
    # <span>, 46 tekens
    ...
    ('Even geen plek? Wij slaan uw inboedel op',
     'Zit er opslag tussen? Ingepakt de kist in'),
    ...
    ('Tijdelijk of voor langere tijd: uw inboedel staat bij De Kievit in houten opslagkisten of een eigen container. Op de afgesproken dag brengen wij alles naar uw nieuwe adres.',
     'De dozen die wij pakten gaan in houten opslagkisten of een eigen container. Binnen Nederland loopt de dekking uit de verhuizing de eerste twaalf maanden mee, binnen Europa dertig dagen.'),
    # <span class=eyebrow>, 26 tekens
    ('Wij zijn Erkende Verhuizer',
     'Wij zijn Erkende Verhuizer'),
    # <h2>, 42 tekens
    ('Acht zekerheden die u er gratis bij krijgt',
     'Acht zekerheden die in de prijs zitten'),
    ...
    ('Erkende Verhuizers is de brancheorganisatie van de Nederlandse verhuisbranche. Het keurmerk mag alleen worden gevoerd door bedrijven die aan de eisen voldoen, en De Kievit Verhuizingen staat in het ledenregister. Wat dat u oplevert, staat hieronder.',
     'Erkende Verhuizers is de brancheorganisatie van de Nederlandse verhuisbranche. Het keurmerk mag alleen worden gevoerd door bedrijven die aan de eisen voldoen, en De Kievit Verhuizingen staat in het ledenregister. Wat dat bij een inpakopdracht betekent, staat hieronder.'),
    # <li>, 227 tekens
    ...
    ('Volgens de Algemene Voorwaarden Verhuizingen (AVVV 2025) en het Garantiecertificaat van de Organisatie voor Erkende Verhuizers.',
     'Volgens de Algemene Voorwaarden Verhuizingen (<a href="/algemene-voorwaarden/#avvv">AVVV 2025</a>), de verzekeringsvoorwaarden <a href="/algemene-voorwaarden/#pv05">PV05 2025</a> en het Garantiecertificaat.'),
    # <p class=label>, 12 tekens
    ('Zo werkt het',
     'In vier stappen'),
    # <h2 class=kop>, 25 tekens
    ('Zo verloopt uw verhuizing',
     'Van opname tot uitgepakt'),
    ...
    ('Vier stappen, en bij elke stap weet u waar u aan toe bent. Van het eerste telefoontje tot het moment dat de laatste doos binnen staat houdt u hetzelfde aanspreekpunt in Venlo, zodat u nooit opnieuw uw verhaal hoeft te doen.',
     'Vier stappen, en bij elke stap weet u waar u aan toe bent. Wat u zelf pakt en wat wij pakken wordt bij de opname per ruimte doorgenomen en komt zo in de offerte te staan. U houdt daarbij hetzelfde aanspreekpunt in Venlo.'),
    # <h3>, 15 tekens
    ('Neem contact op',
     'Bel of app ons'),
    # <p>, 227 tekens
    ('Bel 077 - 32 32 100 of vraag online een offerte aan. Vertel kort waar u vandaan komt, waar u naartoe gaat en wanneer u wilt verhuizen. Wij kijken meteen of die datum nog vrij is en wat er nodig is aan mensen, materiaal en tijd.',
     'Bel 077 - 32 32 100 of vraag online een offerte aan. Zeg erbij hoe groot uw woning is en of u alles wilt laten inpakken of alleen het breekbare. Wij kijken meteen of die datum nog vrij is en wat er nodig is aan mensen en materiaal.'),
    # <h3>, 15 tekens
    ('Opname aan huis',
     'Opname per ruimte'),
    # <p>, 244 tekens
    ('Onze verhuisadviseur komt bij u langs en maakt een plan: welke meubels uit elkaar moeten, wat er ingepakt wordt en waar de wagen kan staan. U ontvangt daarna een gratis en vrijblijvende offerte waarin precies staat wat wij doen en wat het kost.',
     'Onze verhuisadviseur loopt met u door het huis en noteert per kamer wat u zelf doet en wat wij doen. U ontvangt daarna een gratis en vrijblijvende offerte waarin staat welke onderdelen erin zitten, want alleen wat is overeengekomen valt eronder.'),
    # <h3>, 21 tekens
    ('Inpakken en verhuizen',
     'Wij pakken en verhuizen'),
    # <p>, 254 tekens
    ('Op de verhuisdag pakt het team in, demonteert wat nodig is en brengt alles veilig naar uw nieuwe adres. Kwetsbare stukken gaan in verhuisdekens de wagen in en de dozen komen per kamer bij elkaar te staan, zodat u op het nieuwe adres niet hoeft te zoeken.',
     'Wij komen met dozen, papier, tape en garderobedozen. Breekbaar gaat apart, kleding blijft hangen, en op elke doos komt de kamer waar hij heen moet. Daarna gaat alles de wagen in en komen de dozen op het nieuwe adres per kamer bij elkaar te staan.'),
    # <h3>, 25 tekens
    ('Thuis in uw nieuwe woning',
     'Uitpakken en dozen retour'),
    # <p>, 170 tekens
    ('Meubels gemonteerd, wasmachine aangesloten, dozen op hun plek. U betaalt pas na de verhuizing, per bank op factuur, en de lege verhuisdozen halen wij later weer bij u op.',
     'Uitpakken is een apart onderdeel; laat het meebegroten, ook als u nog twijfelt. U betaalt pas na de verhuizing, per bank, en het lege materiaal halen wij later weer bij u op.'),
    # <p class=label>, 23 tekens
    ('Particulier en zakelijk',
     'Meer dan alleen inpakken'),
    # <h2 class=kop>, 51 tekens
    ('E&eacute;n verhuisbedrijf voor alles wat u verhuist',
     'E&eacute;n team voor het pakken en het verhuizen'),
    ...
    ('Bij De Kievit kunt u terecht voor uw particuliere verhuizing, een bedrijfs- of projectverhuizing, inboedelopslag en een verhuizing naar het buitenland. U krijgt dezelfde planner, hetzelfde team en dezelfde voorwaarden, of u nu een appartement in Blerick verhuist of een kantoor met dertig werkplekken.',
     'Het inpakken doen onze eigen mensen: dezelfde ploeg die de dozen vult, tilt ze ook de wagen in en zet ze op het nieuwe adres in de goede kamer neer. Daarnaast kunt u bij De Kievit terecht voor een bedrijfsverhuizing, inboedelopslag, montage en een verhuizing naar het buitenland, met dezelfde planner en dezelfde voorwaarden.'),
    # <span>, 20 tekens
    ...
    ('Verhuizen in Venlo en heel Noord- en Midden-Limburg',
     'Inpakken in Venlo en heel Noord- en Midden-Limburg'),
    ...
    ('Vanuit Venlo verhuizen wij in de hele regio: van Venray en Horst tot Tegelen, Reuver en Roermond, en over de grens in Duitsland en Belgi&euml;. Als lid van Top Movers regelen wij ook verhuizingen naar de rest van Nederland, samen met collega-leden die net als wij Erkende Verhuizer zijn.',
     'Vanuit Venlo pakken wij in waar wij verhuizen: van Venray en Horst tot Tegelen, Reuver en Roermond, en over de grens in Duitsland en Belgi&euml;. Het materiaal brengen wij vooraf langs of nemen wij op de dag mee, en de lege dozen halen wij daarna weer op. Een belletje dat u zover bent is genoeg.'),
    # <li>, 55 tekens
    ...
    ('Verhuist u naar Duitsland? Voor de grensstreek, Noordrijn-Westfalen en Nedersaksen, geldt het Nederlandse Garantiecertificaat van Erkende Verhuizers, net als bij een verhuizing binnen Nederland.',
     'Verhuist u naar Duitsland? Voor de grensstreek, Noordrijn-Westfalen en Nedersaksen, geldt het Nederlandse Garantiecertificaat, en dus ook de dekking op alles wat wij voor u hebben ingepakt.'),
    # <h2 class=kop>, 16 tekens
    ('Goed om te weten',
     'Vragen over inpakken'),
    ...
    ('De vragen die het vaakst terugkomen over kosten, verhuisdozen,\n      opslag, verzekering en planning staan bij elkaar op\n      <a href="/veelgestelde-vragen/">veelgestelde vragen</a>. Staat uw vraag er niet bij, bel dan\n      077 - 32 32 100 of app ons.',
     'Wat wel en niet in een doos mag, wie er aansprakelijk is als u zelf pakt en\n      hoeveel dozen u ongeveer nodig heeft: het staat bij elkaar op\n      <a href="/veelgestelde-vragen/">veelgestelde vragen</a>. Staat uw vraag er niet bij, bel dan\n      077 - 32 32 100 of app ons.'),
    # <span class=eyebrow>, 20 tekens
    ('Vraag uw offerte aan',
     'Vraag uw inpakofferte aan'),
    # <h2>, 32 tekens
    ('Klaar om zorgeloos te verhuizen?',
     'Klaar om de dozen los te laten?'),
    ...
    ('Vul uw gegevens in, dan ontvangt u een gratis en vrijblijvende offerte. Hoe meer u kwijt kunt over uw woning en inboedel, hoe preciezer de prijs.',
     'Vul uw gegevens in, dan ontvangt u een gratis en vrijblijvende offerte. Zeg erbij of u alles wilt laten inpakken of alleen het breekbare.'),
    ...
    ('<p class="label">Inboedelopslag</p>',
     '<p class="label">Ingepakt opslaan</p>'),
    ('>Vraag opslag aan<',
     '>Opslag na het inpakken<'),
    ...
    ('<p class="label">Werkgebied</p>',
     '<p class="label">Waar wij inpakken</p>'),
    ('>App ons uw adressen<',
     '>App ons wat u wilt inpakken<'),
]
