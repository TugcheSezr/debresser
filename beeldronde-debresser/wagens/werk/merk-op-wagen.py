...
VERSIES = {
    2: {"bak": [(1375, 348), (2245, 560), (2255, 1075), (1378, 1120)],
        "deur": (958, 868, 140, 50, -0.175),
        "beeldmerk": (1222, 772, 58, 64, -0.175),
        "frontvlak": [(437, 832), (922, 800), (922, 990), (437, 1000)], "as": 605},
    3: {"bak": [(1410, 500), (1995, 647), (1997, 1095), (1410, 1140)],
        "deur": (1136, 928, 104, 40, -0.40),
        "beeldmerk": (1312, 862, 46, 56, -0.40),
        "frontvlak": [(638, 910), (1119, 888), (1119, 1038), (638, 1052)], "as": 830},
}
...
def main(map_, nr, doelpad=None):
    ...
    witbasis = np.percentile(wit[~groen & (wit > 170)], 75)
